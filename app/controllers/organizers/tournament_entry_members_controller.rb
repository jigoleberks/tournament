class Organizers::TournamentEntryMembersController < Organizers::BaseController
  before_action :load_tournament_and_entry

  def create
    unless @tournament.mode_team?
      return redirect_to edit_organizers_tournament_path(@tournament),
    ...
    unless user
      redirect_to edit_organizers_tournament_path(@tournament), alert: "Member not found." and return
    end
